...
<section id="how-it-works" class="how-it-works">
    <div class="container">
        ...
        <div class="title-container-h1">
            <h1 class="display-h1 h1-underline underline-yellow">How it works.</h1>
        </div>

        <p class="sm-container text-center">Retro Money Beef make it simple for you to make money from your old and
            unwanted items, follow the <strong>4 steps</strong> below and get started.
        </p>
        <div id="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content right">
                    ...
                    <p>
                        ...
                        post office or arrange a free collection.
                    </p>
                    <div class="timeline-number timeline-right">
                        <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/img/hiw-02.png"
                            alt="timeline-number">
                    </div>
                </div>
            </div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <p>
                        When your box arrives our experts will appraise your items and one of our team will call you to
                        let you know your offer.
                    </p>
                    <div class="timeline-number">
                        <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/img/hiw-03.png"
                            alt="timeline-number">
                    </div>
                </div>
            </div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content right">
                    ...
                    <div class="timeline-number timeline-right">
                        <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/img/hiw-04.png"
                            alt="timeline-number">
                    </div>
                </div>
            </div>
