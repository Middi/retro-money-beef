...
function retro_money_beef_scripts() {
	...
	wp_enqueue_script('retro-money-beef-scripts', get_stylesheet_directory_uri() . '/assets/js/main.min.js', array(), filemtime( get_stylesheet_directory() . '/assets/js/main.min.js'), true
	);
